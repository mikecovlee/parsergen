...
losu_grammar.stx = {
    ...
    "load-stmt" : {
        syntax.term("����"), syntax.ref("identifier")
    },
    "import-stmt" : {
        syntax.term("����"), syntax.ref("identifier"), syntax.repeat(syntax.term("/"), syntax.ref("identifier"))
    },
    "method-list" : {
    ...
    "if-stmt" : {
        syntax.term("#"), syntax.term("���"), syntax.ref("expr"),
        syntax.token("endl"), syntax.repeat(syntax.ref("inst-stmt"), syntax.token("endl")), syntax.term(";")
    },
    "loop-stmt" : {
        syntax.term("#"), syntax.term("ѭ��"), syntax.ref("expr"),
        syntax.token("endl"), syntax.repeat(syntax.ref("inst-stmt"), syntax.token("endl")), syntax.term(";")
    },
    "expr-stmt" : {
        syntax.ref("expr")
    ...
    "logic-or-expr" : {
        syntax.ref("logic-and-expr"), syntax.optional(syntax.cond_or({syntax.term("||")}, {syntax.term("��")}), syntax.ref("logic-or-expr"))
    },
    "logic-and-expr" : {
        syntax.ref("equal-expr"), syntax.optional(syntax.cond_or({syntax.term("&&")}, {syntax.term("��")}), syntax.ref("logic-and-expr"))
    },
    "equal-expr" : {
        syntax.ref("relat-expr"), syntax.optional(syntax.cond_or({syntax.term("==")}, {syntax.term("!=")}, {syntax.term("����")}, {syntax.term("������")}), syntax.ref("equal-expr"))
    },
    "relat-expr" : {
